...
import { SiPostman, SiMysql, SiSpring, SiBootstrap, SiFigma, SiAdobephotoshop } from 'react-icons/si';
import profileImg from "../assets/profile.jpg";  // <-- Add image import
    ...
    <section id="about" className="about-section">
      <div className="about-container">
        ...
        <div className="about-image">
          <img src={profileImg} alt="Kamalesh" />
        </div>
